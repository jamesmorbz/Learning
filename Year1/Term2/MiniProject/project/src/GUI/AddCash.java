...
public class AddCash extends JFrame {
	...
	public AddCash() {
		...
		JLabel lblAddCurrentAccount = new JLabel("Add Cash");
		...
		JLabel lblName = new JLabel("Currency: ");
		...
		JLabel lblBalance = new JLabel("Value: ");
		...
		JLabel lblMaximumWithdrawLimit = new JLabel("Interest: ");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String currency = textField.getText();
				double value = Double.parseDouble(textField_1.getText());
				...
				if (value < 0) {
					...
					if (currency == null || value <= 0 || interest <= 0) {
						...
						try {
							FileIO.Investment.addInvestment(currency, value, interest);
						} catch (Exception e1) {
						...
						if (ch == 0) {
							int index = 0;
							try {
								index = FileIO.Investment.addInvestment(currency, value, interest);
							} catch (Exception e1) {
